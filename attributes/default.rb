...
default.elasticsearch[:filename]      = "v#{node.elasticsearch[:version]}.tar.gz"
default.elasticsearch[:download_url]  = "https://github.com/" +
                                        "#{node.elasticsearch[:repository]}/archive/#{node.elasticsearch[:filename]}"
